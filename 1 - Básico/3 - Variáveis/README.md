# Variáveis
São caixas que podem adicionar certas informações. Cada caixa deve ter um nome, mas devem conter o nome relacionado coma informação dessa caixa. Javascript não vai verificar se a informação dentro dessa caixa é equivalente a sua utilização, mas é uma boa prática para a leitura do código.
...
Tanto ler, como var podem ser utilizados para criar variáveis, embora não são a mesma coisa.
